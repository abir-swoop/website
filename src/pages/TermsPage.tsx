    ...
    <Layout content={content}>
      <section className="w-full bg-white px-6 md:px-20 py-20">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-[#595672] mb-8">Applicable to Users, Merchants, and Riders - Nigeria and the Kingdom of Eswatini</p>
          ...
          <div className="prose prose-lg text-[#4a4a6a] space-y-6">
            ...
            <section>
              ...
              <p>These Terms and Conditions ("Terms") constitute a legally binding agreement between you and Thumo Delivery Limited, a company incorporated in Nigeria with its registered office at 2 Birrell Avenue, Yaba, Lagos, Nigeria, trading as "Swoop" ("Swoop", "we", "us", or "our").</p>
            ...
            <section>
              ...
              <p>Users may register by providing their full name, email address, and Nigerian or Eswatini phone number. Phone number verification via One-Time Password (OTP) is required to complete registration.</p>
            ...
            <section>
              ...
              <p>By placing an Order, the User makes an offer to purchase the selected Goods from the Merchant at the displayed price, plus applicable Delivery Fees and Service Fees.</p>
            ...
            <section>
              ...
              <p>The Platform supports the following payment methods: Bank transfer (Nigeria), Debit and credit card payments (Visa, Mastercard, Verve), Swoop Wallet, and Cash on Delivery (Eswatini, subject to order value limits).</p>
              <p>Payment processing is handled by third-party payment processors including Flutterwave, Monnify, and Paystack. By using these payment methods, you also agree to the terms and conditions of the applicable payment processor.</p>
            </section>
            ...
            <section>
              ...
              <p>Merchants are solely responsible for obtaining and maintaining all licences, permits, and registrations required to operate their business.</p>
            </section>
            ...
            <section>
              ...
              <p>The Platform, including its design, software, features, content, trademarks, logos, trade names (including "Swoop" and formerly "Thumo"), and all associated intellectual property rights, are owned by or licensed to Thumo Delivery Limited. All rights are reserved.</p>
            </section>
            ...
            <section>
              ...
              <p>In Nigeria, we process personal data in compliance with the Nigeria Data Protection Act 2023 (NDPA) and the Nigeria Data Protection Regulation 2019 (NDPR).</p>
            ...
            <section>
              ...
              <p>To the maximum extent permitted by applicable law, Swoop's total aggregate liability shall not exceed the greater of: (a) the total fees paid by or to you through the Platform in the six (6) months preceding the claim; or (b) Twenty Thousand Naira (₦20,000) or the equivalent in SZL.</p>
            </section>
            ...
            <section>
              ...
              <p>Any dispute arising out of or relating to these Terms that cannot be resolved amicably within thirty (30) days of written notice shall be referred to and finally resolved by arbitration under the Arbitration and Mediation Act 2023 of Nigeria. The seat of arbitration shall be Lagos, Nigeria.</p>
            </section>
            ...
            <section>
              ...
              <p>
                Thumo Delivery Limited (trading as Swoop)<br/>
                2 Birrell Avenue, Yaba, Lagos, Nigeria<br/>
